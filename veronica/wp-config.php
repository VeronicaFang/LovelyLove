...
define('DB_NAME', 'lovelove_clbc');

/** MySQL 資料庫使用者名稱，請更改 "username_here" */
define('DB_USER', 'lovelove');

/** MySQL 資料庫密碼，請更改 "password_here" */
define('DB_PASSWORD', '1dA4TnQoqgXU');

/** MySQL 主機位址 */
define('DB_HOST', 'db01.coowo.com:3355');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'A a%UqAR:/Hf-zrEi}C;0&k}N.a*T@w+Rtay~A&6&F++HuLODdBr!MV7/8+{^FMi');
define('SECURE_AUTH_KEY',  'EvE Bpa3YB:.Dm9yEla6lhTX$XG]2fM<p|$90V5PD;%7tCD2oGnJoLUhxbcVx>4b');
define('LOGGED_IN_KEY',    '{&!9+g@CHed^.A)|8L,qU!BN!yi${dB))X?rh%?B4d>m*oK)V{zQg;gGr&Zz0#QA');
define('NONCE_KEY',        '#KZzZ.1iQk^]uzP,+U%9@G[u~1/*a/2+U:*-Rt`<~hrm5{n):p8g/ xel6f9.[>;');
define('AUTH_SALT',        'D:Qj)LqDCS&AdL%-HVsBCs3FG;?1|HtwwPhsMr[t]HXfp66hDM?V7-79FtUh,SyC');
define('SECURE_AUTH_SALT', '-6}`PM#0&RFv},qbm#?_,~U0<mK%-x}QQ K a}@S9!XUH+%wwNHYRNJbOpXP<Bn.');
define('LOGGED_IN_SALT',   'Sl_[^nX)F#I3gYp`0!i1ib+$-m?%vxCeZIXlRqva}KJ#NrdyxH-&wYP7/M+lsDez');
define('NONCE_SALT',       '^6sjsP2Dg.x1:T%?</b8 BSgI3m3`680e4;r[S>+nzM s-**e$i24}u6R?:4Q4a=');
